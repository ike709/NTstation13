...
/datum/game_mode/proc/add_law_zero(mob/living/silicon/ai/killer)
	...
	if(prob(80))
		killer << "\red Code Phrase: lack [syndicate_code_phrase]"
	...
	if(prob(80))
		killer << "\red Code Response: lack [syndicate_code_response]"
...
/datum/game_mode/proc/equip_traitor(mob/living/carbon/human/traitor_mob, var/safety = 0)
	...
	if(!safety)//If they are not a rev. Can be added on to.
		...
		if(prob(80))
			traitor_mob << "\red Code Phrase: lack [syndicate_code_phrase]"
			traitor_mob.mind.store_memory("<b>Code Phrase</b>: [syndicate_code_phrase]")
		else
			traitor_mob << "Unfortunetly, the Syndicate did not provide you with a code phrase."
		if(prob(80))
			traitor_mob << "\red Code Response: lack [syndicate_code_response]"
