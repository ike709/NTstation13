/obj/structure/closet/athletic_mixed
	...
	desc = "It's a storage closet for athletic wear."
	icon_state = "mixed"
	icon_closed = "mixed"
...
/obj/structure/closet/boxinggloves
	name = "boxing gloves"
	desc = "It's a storage closet for gloves for use in the boxing ring."
...
/obj/structure/closet/masks
	name = "mask closet"
	desc = "IT'S A STORAGE CLOSET FOR FIGHTER MASKS OLE!"
...
/obj/structure/closet/lasertag/red
	...
	desc = "It's a storage closet for laser tag equipment."
	icon_state = "red"
	icon_closed = "red"
