...
datum/controller/game_controller/proc/setup()
	...
	world.log << "Initializing transfer controller..."

	transfer_controller = new

	//spawn(0)
	world.log << "Beginning pregame..."
	if(ticker)
		ticker.pregame()

datum/controller/game_controller/proc/setup_objects()
	world.log << "Initializing objects..."
	//sleep(-1)
	for(var/atom/movable/object in world)
		object.initialize()

	world.log << "Initializing pipe networks..."
	//sleep(-1)
	for(var/obj/machinery/atmospherics/machine in world)
		machine.build_network()

	world.log << "Initializing atmos machinery..."
//	sleep(-1)
