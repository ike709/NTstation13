...
//Spawns commandos and equips them.
	for(var/obj/effect/landmark/L in landmarks_list)
		...
		if (L.name == "Commando")
			...
			new_commando << "lue You are a Special Ops. [!leader_selected?"commando":"<B>LEADER</B>"] in the service of Central Command. Check the table ahead for detailed instructions.\nYour current mission is: \red<B>[input]</B>"
...
//Spawns the rest of the commando gear.
	...
	message_admins("lue [key_name_admin(usr)] has spawned a CentCom strike squad.", 1)
